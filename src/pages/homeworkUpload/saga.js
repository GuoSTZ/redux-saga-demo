...
export const sagas = Object.assign({}, {
    fetchMyHomeworkMessage: function * (action) {
        let data = yield call(Api.fetchMyHomeworkMessage, action.payload)
        yield put(reducerActions.updateMyHomeworkMessage(data))
    }
})
